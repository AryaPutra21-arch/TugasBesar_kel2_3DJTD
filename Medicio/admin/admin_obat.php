...
require '../fungsi.php';
$Data = AmbilDataDariFunction("SELECT*FROM obat");
// var_dump($Data);
 ?>
		...
		<div style="overflow-x:auto;">
			<table border="1" cellpadding="10" cellspacing="0">
				...
				<tr>
					...
					<td><?php echo $baris["harga_obat"] ?></td>


					<!-- untuk hapus dan delete -->
					<td>
						<a href="update/update_obat.php?nama_obat=<?php echo $baris["nama_obat"]; ?>">ubah</a> 
					</td>
					<td>
						<a href="delete_obat.php?nama_obat=<?= $baris["nama_obat"]; ?>" 
