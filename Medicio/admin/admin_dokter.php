...
require '../fungsi.php';
$Data = AmbilDataDariFunction("SELECT*FROM dokter");
// var_dump($Data);
 ?>
		...
		<div style="overflow-x:auto;">
			<table border="1" cellpadding="10" cellspacing="0">
				...
				<tr>
					...
					<td><?php echo $baris["jam_kerja"]; ?></td>
					<td><?php echo $baris["waktu_penanggung_jawab"] ?></td>
					
					<td>
						<a href="update/update_dokter.php?id_dokter=<?php echo $baris["id_dokter"]; ?>">ubah</a> 
					</td>
					<td>
						<a href="delete_dokter.php?id_dokter=<?= $baris["id_dokter"]; ?>" 
